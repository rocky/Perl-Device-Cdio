...
if ( perliso9660::pathname_valid_p("OKAY/FILENAMETOOLONG.EXT") ) {
    printf(
        "OKAY/FILENAMETOOLONG.EXT should fail perliso9660::dirname_valid_p\n");
    $bad++;
}
...
my @tm = localtime(0);
my $dtime =
  perliso9660::set_dtime( $tm[0], $tm[1], $tm[2], $tm[3], $tm[4], $tm[5] );
...
@tm = gmtime();
my $ltime =
  perliso9660::set_ltime( $tm[0], $tm[1], $tm[2], $tm[3], $tm[4], $tm[5] );
( $bool, @new_tm ) = perliso9660::get_ltime($ltime);
