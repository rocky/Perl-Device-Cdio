...
can use this library.
    ...
    @drives = Device::Cdio::get_devices_with_cap($perlcdio::FS_AUDIO, 0);
...
The more object-oriented package Device::Cdio and uses uses
perlcdio. (Actually, there are no objects in Device::Cdio, but there
are in its sub packages Device::Cdio::Device and
Device::Cdio::Tracks).
